      ...
      <Header />
        ...
        <div className="best-jouets" style={{textAlign: 'center', backgroundColor: '#F5F5F5'}}>
          ...
          <div className="products-container">
            <div>
              <GrosCardJouet seller="Best Seller" title="La PlayBoard" description="L'outil d'éveil et d'apprentissage le plus complet pour les enfants de 1 à 6 ans." className="jouet1-img"/>
            </div>
            <div>
