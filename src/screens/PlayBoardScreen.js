          ...
          <div className="playboard-container">
            <div className="playboard-description">
              ...
              <div className="playboard-image">
                <img src="https://maxandlea.com/wp-content/uploads/2020/10/VueProduit-Tablette-MaxAndLea-2-min.png" alt=""/>
              </div>
              <div className="playboard-petites-images">
                <Row className="">
                  <Col sm={12} md={2} lg={2} xl={2}>
                    <img src="https://maxandlea.com/wp-content/uploads/2020/10/VueProduit-Tablette-MaxAndLea-2-min-100x100.png" alt=""/>
                    <img src="https://maxandlea.com/wp-content/uploads/2020/05/VISUEL-CTA-EN-100x100.jpg" alt=""/>
                    <img src="https://maxandlea.com/wp-content/uploads/2020/05/TabletteUtilisée-VueDessus-100x100.jpg" alt=""/>
              ...
              <div className="succes-playboard">
                ...
                <p className="playboard-succes">Victime de son succès, la PlayBoard est actuellement en rupture de stock. Elle sera de nouveau disponible le 01/03/2021.
                ...
                <p className="description-playboard">La PlayBoard est le jouet le plus complet pour <span>stimuler l’éveil</span> et la <span>motricité fine des enfants. </span>

                   La PlayBoard est une véritable boite à outils avec laquelle votre petit <span>développera ses talents.</span> Votre enfant apprendra <span>à son rythme</span> et <span>en s’amusant.</span></p>
                <div className="ebookgratuits">
                  <img src="https://play.maxandlea.com/wp-content/uploads/2020/05/dot_4.svg" alt=""/>
                  <p style={{fontWeight: 'bold'}}>3 ebooks <span style={{textDecoration: 'underline'}}>GRATUITS</span> avec votre PlayBoard</p>
                </div>
                <div className="rangement-offert">
                  ...
                  <p style={{fontWeight: 'bold'}}>Un sac de rangement <span style={{textDecoration: 'underline'}}>OFFERT</span></p>
                </div>
              </div>
            </div>
            </div>
